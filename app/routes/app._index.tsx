  ...
  return (
    <s-page heading="Shopify app template">
      <s-section heading="Congrats on creating a new Shopify app 🎉">
        <s-paragraph>This will be where the results be</s-paragraph>
      </s-section>
      <s-section heading="Get started with products">
        <s-paragraph>This is where the table will be</s-paragraph>
      </s-section>
      ...
      <s-section slot="aside" heading="Apply Tag">
        <s-text-field value="" placeholder="Free shipping" />
